...
?>
<div class="user-profile-classes-search element-to-toggle" data-toggle-element="form-search">
...
<!-- code -->
<div class="col-md-4"> <?= 
$form->field($model, 'code')->textInput(['placeholder' => 'ricerca per code' ]) ?>

 </div> 

<!-- enabled -->
<div class="col-md-4"> <?= 
$form->field($model, 'enabled')->textInput(['placeholder' => 'ricerca per enabled' ]) ?>
